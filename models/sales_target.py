...
class SalesTarget(models.Model):
    ...
    @api.depends('total_sales', 'target_amount', 'state')
    def _compute_achievement(self):
        for record in self:
            ...
            if record.achievement_progress >= 100:
                record.achievement_state = 'completed'
            elif record.state == 'closed':
                record.achievement_state = 'failed'
            else:
                record.achievement_state = 'progress'
